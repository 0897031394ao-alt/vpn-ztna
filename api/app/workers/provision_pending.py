...
from app.services.peer_service import provision_peer_by_id
...
async def run_forever(interval_seconds: int = 5) -> None:
    ...
    """
    print(f"Starting provision worker loop, interval={interval_seconds}s, statuses=['pending']")
    empty_cycles = 0
